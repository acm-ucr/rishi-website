    ...
    <div className=" flex justify-center flex-col items-center h-full w-full ">
      <div className="md:flex grid grid-cols-2 gap-5 justify-around w-11/12 h-2/5 ">
        <Link
          ...
          target="_blank"
          className="border-2 border-rishi-green  rounded-2xl flex justify-center items-center sm:w-1/2 lg:w-1/4 xl:w-1/5 h-full py-2  "
        >
        ...
        <Link
          ...
          target="_blank"
          className="border-2 border-rishi-orange rounded-2xl flex justify-center items-center sm:w-1/2 lg:w-1/4 xl:w-1/5 h-full py-2 "
        >
